"""example-service — a production-shaped microservice from the golden path.
...
Configuration is read from the environment (12-factor):
  ...
  SERVICE_NAME   name reported in payloads (default "example-service")
...
SERVICE_NAME = os.environ.get("SERVICE_NAME", "example-service")
...
class Handler(BaseHTTPRequestHandler):
    ...
    server_version = "example-service/1.0"
