...
{{/*
Selector labels. These are immutable on a Deployment's selector, so keep them
to the stable name+instance pair only.
*/}}
...
{{/*
Resolve the image reference (repository:tag), defaulting the tag to the chart
